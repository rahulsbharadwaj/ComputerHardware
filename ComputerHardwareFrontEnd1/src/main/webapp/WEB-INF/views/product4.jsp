...
<head>
		...
		<title>GamersRig-Hard Disk</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Seagate New BarraCuda </li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							...
							<div class="product-preview">
								<img src="${img1}/hard disk/seagate/22-178-993-V01.jpg" alt="">
							</div>

							<div class="product-preview">
								<img src="${img1}/hard disk/seagate/22-179-010-06.jpg" alt="">
							</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">Seagate New BarraCuda </h2>
							
							<div>
								<h3 class="product-price">RS.3600.00<del class="product-old-price">RS.5600.00</del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p><li>Cost-effective storage upgrade for desktop computers</li>
                                                                                           <li>Store all your games, music, movies and more with up to 1TB of storage</li>
                                                                                           <li> SATA 6Gb/s interface optimizes burst performance; 64MB Cache<li>
                                                            				               <li>Seagate Secure models for hardware-based data security</li>
                                                                                           <li>Instant Secure Erase allows safe and easy drive retirement</li>
                                                         </p>
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<p>
<li>Brand	                Seagate</li>
<li>Series	                ST1000DM010</li>
<li>Colour	                Silver</li>
<li>Item Height	            20 Millimeters</li>
<li>Item Width	            10.2 Centimeters</li>
<li>Screen Size	            3.50 Inches</li>
<li>Item Weight	            417 g</li>
<li>Product Dimensions	    14.7 x 10.2 x 2 cm</li>
<li>Item model number	    ST1000DM010</li>
<li>RAM Size	            1 TB</li>
<li>Computer Memory Type	EDO DRAM</li>
<li>Hard Drive Size       	1 TB</li>
<li>Wireless Type	        Radio Frequency</li>
<li>Wattage	                5.30</li>
										</div>
									</div>
								</div>
