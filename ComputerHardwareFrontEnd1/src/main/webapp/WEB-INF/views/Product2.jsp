...
<head>
		...
		<title>GamersRig-Intel i5</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Intel Core i5-8400 BX80684I58400 Processor</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							...
							<div class="product-preview">
								<img src="${img1}/cpu/intel/i5/2.jpg" alt="">
							</div>

							<div class="product-preview">
								<img src="${img1}/cpu/intel/i5/3.jpg" alt="">
							</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">Intel Core i5-8400 BX80684I58400 Processor</h2>
							
							<div>
								<h3 class="product-price">RS.24500.00<del class="product-old-price">RS.30000.00</del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p><li>Compatible only with Motherboards based on Intel 300 Series Chipsets</li>
                                                           <li> 6 Cores/6 Threads</li>
                                                           <li> 2.80 GHz up to 4.00 GHz Max Turbo Frequency/9 MB Cache<li>
							...
							<div class="tab-content">
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<p><li>Brand	        	Intel</li>
<li>Item Height	        	10.2 Centimeters</li>
<li>Item Width	        	7.6 Centimeters</li>
<li>Item Weight	                259 g</li>
<li>Product Dimensions	        12.7 x 7.6 x 10.2 cm</li>
<li>Item model number	        BX80684I58400</li>
<li>Processor Type	        Core i5</li>
<li>Processor Speed	        2.8 GHz</li>
<li>Processor Count	        6</li>
<li>Computer Memory Type	DDR4 SDRAM</li>
<li>Wattage	                65</li>
<li>Included Components	        Processor, Fan/Heatsink, Manual</li>.</p>
										</div>
									</div>
								</div>
								<!-- /tab2  -->
