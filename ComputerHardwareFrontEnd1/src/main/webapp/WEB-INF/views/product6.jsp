...
<head>
		...
		<title>GamersRig-Mother-Board</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">MSI Pro Series Intel Coffee Lake LGA 1151 </li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							...
							<div class="product-preview">
								<img src="${img1}/mother board/intel/msi/57-1597.jpg" alt="">
							</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">MSI Pro Series Intel Coffee Lake LGA 1151</h2>
							
							<div>
								<h3 class="product-price">RS.12800.00<del class="product-old-price">RS.18200.00</del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p><li>Supports 8th Gen Intel Core/Pentium Celeron processors for LGA 1151 socket</li>
                                                           <li>Supports DDR4 memory, up to 4000+(OC) MHz</li>
                                                           <li> DDR4 Boost: Advanced technology provided by MSI OC lab to ensure maximum compatibility for overclocking performance<li>
                                                            <li>Audio Boost: Reward your ears with studio grade sound quality for the most immersive audio experience</li>
                                                            <li>Mystic Light and Mystic Light Sync: Personalize your PC with 7 colors/5 effects controlled in one click with the Mystic Light APP or a mobile device</li>
                                                         </p>
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<p>
<li>Brand				MSI</li>
<li>Model				Z370 PC PRO</li>
<li>Model Name				Z370 PC PRO</li>
<li>Model Year				2017</li>
<li>Item Weight				1.12 Kg</li>
<li>Product Dimensions			34.8 x 26.9 x 7.9 cm</li>
<li>Batteries:				1 Lithium Metal batteries required. (included)</li>
<li>Item model number			Z370 PC PRO</li>
<li>Computer Memory Type		DDR4 SDRAM</li>
<li>Processor Socket			Socket 1151</li>
<li>Included Components			Motherboard</li>
<li>Optical Zoom			100 X</li>
<li>Wattage				125</li>
<li>Batteries Included			Yes</li>
<li>Batteries Required			No</li>
<li>Wireless Type			802.11.a</li>
<li>Has Auto Focus	      		No</li>
<li>Supports Bluetooth Technology	No</li>
<li>Programmable Buttons	        No</li>
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								...
								<h3 class="product-name"><a href="#">Cooler Master MasterCase H500P ATX Mid-Tower</a></h3>
