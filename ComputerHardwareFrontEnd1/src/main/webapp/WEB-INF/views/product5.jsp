...
<head>
		...
		<title>GamersRig-Graphic Card</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">MSI GTX 1080 TI  </li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							...
							<div class="product-preview">
								<img src="${img1}\graphic card\MSI GeForce GTX 1080 Ti\14-137-114-V12.jpg" alt="">
							</div>

							<div class="product-preview">
								<img src="${img1}\graphic card\MSI GeForce GTX 1080 Ti\14-137-114-V16.jpg" alt="">
							</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">MSI GTX 1080 TI Gaming X Video Graphic Cards</h2>
							
							<div>
								<h3 class="product-price">RS.73300.00<del class="product-old-price">RS.90000.00</del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p><li>Chipset: NVIDIA GeForce GTX 1080 Ti</li>
                                                                                           <li>Video Memory: 11GB GDDR5X</li>
                                                                                           <li> SMemory Interface: 352-bit<li>
                                                            				               <li>Max. Resolution: Support 4x Display Monitors</li>
                                                                                           <li>Input: 2x 8pin PCI-E Power Connectors</li>
                                                         </p>
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<p>
<li>Brand 	                  MSI</li>
<li>Item Height	              41 Millimeters</li>
<li>Item Width	              14 Centimeters</li>
<li>Item Weight	              1.91 Kg</li>
<li>Product Dimensions	      29 x 14 x 4.1 cm</li>
<li>Item model number	      GTX 1080 TI GAMING X</li>
<li>Processor Count	          2</li>
<li>Computer Memory Type	  DDR SDRAM</li>
<li>Graphics Coprocessor	  GeForce GTX</li>
<li>Graphics Chipset Brand	  GTX 1080 TI</li>
<li>Graphics RAM Type	      DDR5 SDRAM</li>
<li>Graphics Card Ram Size	  11</li>
<li>Graphics Card Interface	  Integrated</li>
<li>Wattage	                  600 Watts</li>
<li>Included Components	      Video Card</li>
										</div>
									</div>
								</div>
								<!-- /tab2  -->
